...
public:
  ...
  int getPredecessor(int value) const; // returns the predecessor value of the
                                       // given value or 0 if there is none
  int getSuccessor(int value) const; // returns the successor value of the given
                                     // value or 0 if there is none
  bool remove(
      int value); // deletes the Node containing the given value from the tree
...
private:
  ...
  Node *getNodeFor(int value,
                   Node *n) const; // IMPLEMENT THIS FIRST: returns the node for
                                   // a given value or NULL if none exists
  ...
  // these should be used by getPredecessor and getSuccessor, and ONE of them
  // should be used by remove
  Node *getSuccessorNode(int value)
      const; // returns the Node containing the successor of the given value
  Node *getPredecessorNode(int value)
      const; // returns the Node containing the predecessor of the given value
};
